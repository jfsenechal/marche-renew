      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-8 ml-0 md:ml-4">
        <div
          ...
          <h3 class="text-lg md:text-xl font-bold">
            <NuxtLink :to="`/${siteSlug}/article/${categorySelected}/${post.ID}`" v-text="post.post_title"></NuxtLink>
          </h3>
          <p class="mt-2 text-text/70 line-clamp-3" v-if="post.post_excerpt" v-text="post.post_excerpt"></p>
